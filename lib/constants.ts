...
export const DATE = '07 December 2022';
export const SHORT_DATE = 'Dec 7 - 9:00am PST';
export const FULL_DATE = 'Dec 7th 9am Pacific Time (GMT-7)';
...
export const REPO = 'https://github.com/flowscience/virtual-event-starter-kit';
